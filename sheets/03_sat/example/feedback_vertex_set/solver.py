...
class FeedbackVertexSetDecisionVariant:
    ...
    def solve(self, time_limit: float = 900) -> set[Node] | None:
        ...
        self._logger.info("Starting SAT solver with k=%d", self.k)
...
class FeedbackVertexSetSolverSAT:
    ...
    def __init__(self, graph: nx.Graph, logger: logging.Logger | None = None) -> None:
        ...
        self._logger.info(
            "Initializing FeedbackVertexSetSolverSAT with %d nodes and %d edges...",
        ...
        self._logger.info("FeedbackVertexSetSolverSAT initialized successfully!")
    ...
    def solve(
        ...
        self._logger.info(
            "Best solution found with size %d",
            len(self.best_solution),
        )
